                ...
                <div class="member-navigator relative flex flex-col-reverse lg:flex-col">
                    <div class="form-wrapper service-navi mb-[1.5rem] lg:mb-0 lg:hidden">
                        <select class="form-style" id="menu-news" name="selectName" onchange="location = this.value;">
                            <option value="#"> Article Category 1</option>
                            <option value="#"> Article Category 2</option>
                            <option value="#"> Article Category 3</option>
                            <option value="#"> Article Category 4</option>
                            <option value="#"> Article Category 5</option>
                        </select>
                    </div>
                    <div class="sticky lg:top-[85px] mb-[.5rem] lg:mb-0 menu-d">
                        <p class="th-5 fs-24 lg:mb-[1rem] title-article ">Article</p>
                        <div class="hidden lg:block">
                            <ul class="mmenu ">
                                <li class="full-url mb-2 il-article active">
                                    <p class="th-3 fs-18">Article Category 1</p>
                                    <a href="{{ url('#') }}"></a>
                                </li>
                                <li class="full-url mb-2 il-article">
                                    <p class="th-3 fs-18">Article Category 2</p>
                                    <a href="{{ url('#') }}"></a>
                                </li>
                                <li class="full-url mb-2 il-article">
                                    <p class="th-3 fs-18">Article Category 3</p>
                                    <a href="{{ url('#') }}"></a>
                                </li>
                                <li class="full-url mb-2 il-article">
                                    <p class="th-3 fs-18">Article Category 4</p>
                                    <a href="{{ url('#') }}"></a>
                                </li>
                                <li class="full-url mb-2 il-article">
                                    <p class="th-3 fs-18">Article Category 5</p>
                                    <a href="{{ url('#') }}"></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tn:w-1/2 md:w-1/3 mb-[1rem]">
                            <div class="blog-box-wrapper">
                                <div class="blog-box-img">
                                    <img src="{{ Module::asset('frontend:img/home/Scan-300x231.jpg') }}" />
                                    <a href="{{ url('article-detail') }}"></a>
                                </div>
